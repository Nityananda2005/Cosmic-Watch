...
const AsteroidDetails = () => {
  ...
  if (error) return (
    <DashboardLayout>
      <div className="flex-1 flex items-center justify-center p-6 text-red-400">{error}</div>
    </DashboardLayout>
  );
  ...
  return (
    <>
      <style>{`
        ...
        .neo-details-main { position: relative; z-index: 10; margin-left: 0; max-width: 1400px; padding: 1rem; }
        @media (min-width: 640px) { .neo-details-main { padding: 1.5rem 2rem; } }
        @media (min-width: 1024px) { .neo-details-main { padding: 2rem 3rem; } }
        ...
        @media (max-width: 768px) { .neo-asteroid-name { font-size: 1.75rem; } .neo-card { padding: 1.25rem; } .neo-identity { padding-bottom: 1.5rem; margin-bottom: 1.5rem; } .neo-badges { flex-direction: column; align-items: center; } .neo-metrics-grid { grid-template-columns: 1fr; } .neo-size-comparison { flex-direction: column; } .neo-actions { flex-direction: column; } .neo-btn { width: 100%; justify-content: center; } }
      `}</style>
      ...
      <DashboardLayout>
        <div className="neo-details-wrap flex-1 min-h-0">
