...
export default function Auth() {
    ...
    const handleRegisterSubmit = async (e) => {
        ...
        try {
            ...
            await register(firstname, lastname, registerForm.email, registerForm.password);
    ...
    return (
        ...
        >
            ...
            <button
                type="button"
                onClick={() => navigate(-1)}
                className={`absolute left-4 top-6 z-20 inline-flex items-center gap-2 rounded-full border px-3 py-1.5 text-xs font-medium transition-colors ${
                    isDark
